...
var Hn = V(() => {
  ...
  $r = /* @__PURE__ */ new Map(), Et = [], kt = (t, e, r) => {
  ...
  }, _f = (t) => __async(null, null, function* () {
    let e = $r.get(t);
    ...
    if (e.aborted) return e.error;
    {
      let r = !!e.initPromise;
      try {
        return r || (e.initPromise = e.backend.init(t)), yield e.initPromise, e.initialized = true, e.backend;
      } catch (n) {
  ...
  }), za = (t) => __async(null, null, function* () {
...
var Ka = V(() => {
  ...
  }, Wa = (t, e) => __async(null, null, function* () {
  ...
  Tr = class t {
    ...
    run(e, r, n) {
      return __async(this, null, function* () {
        ...
        let u = yield this.handler.run(e, o, i), d = {};
    ...
    static create(e, r, n, o) {
      return __async(this, null, function* () {
        ...
        let [u, d] = yield za(s), c = yield u.createInferenceSessionHandler(i, d);
...
Vt(ms, { default: () => xf });
function ps() {
  return __async(this, arguments, function* (t = {}) {
    ...
    let i = (a) => (...l) => __async(null, null, function* () {
      try {
        if (e.$c) throw Error("Session already started");
        let h = e.$c = { Nd: l[0], errors: [] }, f = yield a(...l);
        if (e.$c !== h) throw Error("Session mismatch");
        e.gd?.flush();
        let _ = h.errors;
        if (0 < _.length) {
          let C = yield Promise.all(_);
...
`));
    ...
    if (r || n) {
      ...
      n && (d = (a) => {
      ...
      }), u = (a) => __async(null, null, function* () {
        ...
        var l = yield fetch(a, { credentials: "same-origin" });
    ...
    function Se() {
      return __async(this, null, function* () {
        ...
        }) : o ? a(new WebAssembly.Instance(b, X()), b) : (ie ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href, l = yield (function(f) {
          return __async(this, null, function* () {
            var _ = ie;
            if (!g && !z(_)) try {
              var C = fetch(_, { credentials: "same-origin" });
              return yield WebAssembly.instantiateStreaming(C, f);
            } catch (P) {
            ...
            return (function(P, B) {
              return __async(this, null, function* () {
                try {
                  ...
                  return yield WebAssembly.instantiate(G, B);
                } catch (H) {
    ...
    function Gp(a) {
      return a >>>= 0, bi(() => __async(null, null, function* () {
        var l = yield Ge(a);
        return qe(l);
      }));
    }
...
`))[0] == "Error" && f.shift(), Ci(f);
    ...
    o || (function() {
      ...
      Xe.push(() => __async(null, null, function* () {
        var l = (function() {
          return __async(this, null, function* () {
            if (!o) return Promise.all(ft.map(Ho));
          });
        })();
        Ce++, yield l, --Ce == 0 && $e && (l = $e, $e = null, l());
      }));
    ...
    function Am(a, l, h) {
      return bi(() => __async(null, null, function* () {
        yield e.Gd(Number(a), Number(l), Number(h));
      }));
    }
    function Em() {
    ...
    return o || (ct = yield Se(), vr()), e.PTR_SIZE = 4, we ? e : new Promise((a, l) => {
      w = a, S = l;
    });
  });
}
...
var Cr = V(() => {
  ...
  ys = typeof location > "u" ? void 0 : location.origin, Xn = import.meta.url > "file:" && import.meta.url < "file;", Tf = () => {
  ...
  }, Cf = (t, e) => `${e ?? "./"}${t}`, ws = (t) => __async(null, null, function* () {
    let r = yield (yield fetch(t, { credentials: "same-origin" })).blob();
    return URL.createObjectURL(r);
  }), Af = (t) => __async(null, null, function* () {
    return (yield import(
      /*webpackIgnore:true*/
      /*@vite-ignore*/
      t
    )).default;
  }), hs = (cs(), Yt(ls)).default, _s = () => __async(null, null, function* () {
    if (!Le) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
    if (Yn(Le)) return [void 0, hs()];
    let t = yield ws(Le);
    return [t, hs(t)];
  }), gs = (fs(), Yt(ms)).default, vs = (t, e, r, n) => __async(null, null, function* () {
    let o = gs && !(t || e);
    ...
    {
      let i = "ort-wasm-simd-threaded.jsep.mjs", s = t ?? If(i, e), u = r && s && !Yn(s, e), d = u ? yield ws(s) : s ?? Cf(i, e);
      return [u ? d : void 0, yield Af(d)];
    }
  });
});
var Jn;
...
var vt = V(() => {
  ...
  eo = false, Mr = false, $s = false, Ef = () => {
  ...
  }, Ar = (t) => __async(null, null, function* () {
    ...
    let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, u = s?.href ?? s, d = o?.wasm, c = d?.href ?? d, p = t.wasmBinary, [m, g] = yield vs(u, i, r > 1, !!p || !!c), b = false, y = [];
    ...
    })), yield Promise.race(y), b) throw new Error(`WebAssembly backend initializing failed due to timeout: ${e}ms`);
  }), ge = () => {
    if (eo && Jn) return Jn;
...
var Is = V(() => {
  ...
  Of = (t) => {
  ...
  }, Bf = (t, e, r) => __async(null, null, function* () {
    ...
    for (let o of n) {
      ...
      (yield ge()._OrtAppendExecutionProvider(t, u, c, p, d)) !== 0 && me(`Can't append execution provider: ${i}.`);
    }
  }), Ts = (t) => __async(null, null, function* () {
    let e = ge(), r = 0, n = [], o = t || {};
    Df(o);
    try {
      ...
      if (r = e._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, s, !!o.enableProfiling, 0, u, d, c, p), r === 0 && me("Can't create session options."), o.executionProviders && (yield Bf(r, o, n)), o.enableGraphCapture !== void 0) {
...
var ro = V(() => {
  "use strict";
  Ir();
  rr = (t) => __async(null, null, function* () {
    if (typeof t == "string") if (false) try {
      let { readFile: e } = Gn("node:fs/promises");
      return new Uint8Array(yield e(t));
    } catch (e) {
      if (e.code === "ERR_FS_FILE_TOO_LARGE") {
        let { createReadStream: r } = Gn("node:fs"), n = r(t), o = [];
        try {
          for (var iter = __forAwait(n), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
            let i = temp.value;
            o.push(i);
          }
        } catch (temp) {
      ...
      if (n < 1073741824) return new Uint8Array(yield e.arrayBuffer());
      {
        ...
        let s = 0;
        for (; ; ) {
          let { done: u, value: d } = yield o.read();
          if (u) break;
          let c = d.byteLength;
    ...
    else return t instanceof Blob ? new Uint8Array(yield t.arrayBuffer()) : t instanceof Uint8Array ? t : new Uint8Array(t);
  });
});
var Mf;
var Rf;
  ...
  Os = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), ao = (t, e) => {
    ...
    read(e) {
      return __async(this, null, function* () {
        if (this.fallbackDataType) {
          let r = yield this.mlContext.readTensor(this.mlTensor), n = zs(new Uint8Array(r), this.dataType);
          if (e) {
      ...
      return __async(this, null, function* () {
        ...
        if (this.wrapper) {
          ...
          if (o) {
            ...
            this.activeUpload = new Uint8Array(yield this.wrapper.read());
          }
          this.tensorManager.releaseTensor(this.wrapper);
        }
        let d = typeof MLTensorUsage > "u" ? void 0 : MLTensorUsage.READ | MLTensorUsage.WRITE;
        return this.wrapper = yield this.tensorManager.getCachedTensor(e, r, n, d, true, true, u), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
      });
    }
    upload(e) {
      let r = e;
    ...
    getCachedTensor(e, r, n, o, i, s, u) {
      return __async(this, null, function* () {
        ...
        let c = yield d.createTensor({ dataType: u ?? r, shape: n, dimensions: n, usage: o, writable: i, readable: s });
  ...
  qr = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), Lf = (t, e) => {
    ...
    createMLContext(e) {
      return __async(this, null, function* () {
        if (e instanceof GPUDevice) {
          ...
          {
            let o = yield navigator.ml.createContext(e);
          ...
          if (n !== -1) return this.mlContextCache[n].mlContext;
          {
            let o = yield navigator.ml.createContext();
        ...
        {
          let n = yield navigator.ml.createContext(e);
    ...
    createTemporaryTensor(e, r, n) {
      return __async(this, null, function* () {
        ...
        yield this.tensorManager.ensureTensor(e, i, o, n, false);
    ...
    createMLTensorDownloader(e, r) {
      return () => __async(this, null, function* () {
        let n = yield this.tensorManager.download(e);
        return Gr(n, r);
      });
    }
...
var Ws = V(() => {
  ...
  Us = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), so = [], uo = (t) => Math.ceil(Number(t) / 16) * 16, Wf = (t) => {
  ...
  }, Gf = 1, Ns = () => Gf++, co = (t, e, r, n) => __async(null, null, function* () {
    let o = uo(r), i = t.device.createBuffer({ size: o, usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ });
    try {
      let s = t.getCommandEncoder();
      t.endComputePass(), s.copyBufferToBuffer(e, 0, i, 0, o), t.flush(), yield i.mapAsync(GPUMapMode.READ);
    ...
    download(e, r) {
      return __async(this, null, function* () {
        ...
        yield co(this.backend, n.gpuData.buffer, n.originalSize, r);
      });
    }
...
var vu = V(() => {
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    let { inputs: r, outputCount: n } = t, o = xh(__spreadProps(__spreadValues({}, e), { outputCount: n }));
...
var Ud = V(() => {
  ...
  Kh = (t, e, r, n, o, i) => {
    ...
    return __spreadProps(__spreadValues({ autoPad: n, format: r, dilations: o, group: i, kernelShape: s, pads: u, strides: d, wIsConst: c }, e), { cacheKey: `${t.format};${e.activation};` });
  }, Rd = (t, e, r, n) => {
    ...
    let o = [0, e.pads[0], 0, e.pads[1]], i = [1].concat(e.strides), s = [1].concat(e.dilations), u = [1].concat(e.kernelShape), d = So(__spreadProps(__spreadValues({}, e), { pads: o, strides: i, dilations: s, kernelShape: u }), n);
...
var Fd = V(() => {
  ...
  Yh = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, Xh = (t, e, r, n, o) => {
    ...
    return __spreadProps(__spreadValues({ autoPad: n, format: r, dilations: o, group: i, kernelShape: s, outputPadding: p, outputShape: m, pads: u, strides: d, wIsConst: c }, e), { cacheKey: `${t.format};${e.activation};` });
  }, eg = (t, e) => {
    if (!t || t.length !== 2 && t.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
    ...
    d = [0].concat(d);
    let c = Ld(__spreadProps(__spreadValues({}, e), { pads: u, strides: s, dilations: i, kernelShape: o, outputPadding: d }), n);
...
var ko = V(() => {
  ...
  }, Cl = (t) => ee(__spreadValues({}, t)), Il = ee({ perm: [0, 2, 1, 3] }), zg = (t, e, r, n, o, i, s) => {
...
var dc = V(() => {
  ...
  cn = (t) => {
    ...
    let n = __spreadProps(__spreadValues({ countIncludePad: e }, r), { cacheKey: "" });
    return __spreadProps(__spreadValues({}, n), { cacheKey: oy(n) });
  }, ec = (t, e) => {
    ...
    let e = t.format;
    return __spreadProps(__spreadValues({ format: e }, tc), { cacheKey: e });
  }, nc = (t, e) => {
    ...
    let o = __spreadProps(__spreadValues({ storageOrder: e, dilations: r }, n), { cacheKey: "" });
    return __spreadProps(__spreadValues({}, o), { cacheKey: iy(o) });
  }, sc = (t) => {
    let e = t.format;
    return __spreadProps(__spreadValues({ format: e }, tc), { cacheKey: e });
  }, uc = (t, e) => {
  ...
  Wy = (t, e) => {
    ...
    initialize(e, r) {
      return __async(this, null, function* () {
        ...
        i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = yield r.requestDevice(o), this.adapterInfo = new Do(r.info || (yield r.requestAdapterInfo())), this.gpuDataManager = Ls(this), this.programManager = new mn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Lr(e.logLevel, !!e.debug), this.device.onuncapturederror = (s) => {
    ...
    download(e, r) {
      return __async(this, null, function* () {
        yield this.gpuDataManager.download(e, r);
      });
    }
    alloc(e) {
...
var Gc = V(() => {
  ...
  sr = class t {
  ...
  }, Hy = (t, e, r, n) => __async(null, null, function* () {
    let o = e.jsepInit;
    ...
    if (t === "webgpu") {
      ...
      yield s.initialize(r, n), o("webgpu", [s, (u) => s.alloc(Number(u)), (u) => s.free(u), (u, d, c, p = false) => {
      ...
      }, (u, d, c) => __async(null, null, function* () {
        se("verbose", () => `[WebGPU] jsepCopyGpuToCpu: gpuDataId=${u}, dataOffset=${d}, size=${c}`), yield s.download(Number(u), () => e.HEAPU8.subarray(Number(d) >>> 0, Number(d + c) >>> 0));
      ...
      let i = new Kr(r);
      o("webnn", [i, () => i.reserveTensorId(), (s) => i.releaseTensorId(s), (s, u, d, c, p) => __async(null, null, function* () {
        return i.ensureTensor(s, u, d, c, p);
      }), (s, u) => {
        i.uploadTensor(s, u);
      }, (s, u) => __async(null, null, function* () {
        return i.downloadTensor(s, u);
      }), (s, u) => i.registerMLContext(s, u), !!r.trace]);
    }
  });
});
var Fy;
...
var Qn = V(() => {
  ...
  Fy = (t, e) => {
  ...
  }, Er = (t) => __async(null, null, function* () {
    Fy(t.wasm.numThreads, tr(t.logLevel));
  }), kr = (t, e) => __async(null, null, function* () {
    ge().asyncInit?.();
    ...
    if (e === "webgpu") {
      ...
      if (r) {
        ...
        if (r = yield navigator.gpu.requestAdapter({ powerPreference: n, forceFallbackAdapter: o }), !r) throw new Error('Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.');
      }
    }
    if (e === "webnn" && (typeof navigator > "u" || !navigator.ml)) throw new Error("WebNN is not supported in current environment");
    {
      let n = (Gc(), Yt(Wc)).init;
      e === "webgpu" && (yield n("webgpu", ge(), t, r)), e === "webnn" && (yield n("webnn", ge(), t));
    }
    ...
    try {
      ...
      for (let I of e?.executionProviders ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof I != "string") {
          ...
          z ? o.currentContext = z : v ? o.currentContext = yield o.webnnCreateMLContext(v) : o.currentContext = yield o.webnnCreateMLContext({ deviceType: M, powerPreference: N });
        } else o.currentContext = yield o.webnnCreateMLContext();
        break;
      }
      i = yield o._OrtCreateSession(r, n, s), o.webgpuOnCreateSession?.(i), i === 0 && me("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
  ...
  }, Fc = (t, e, r, n, o, i, s = false) => __async(null, null, function* () {
    if (!t) {
      e.push(0);
      return;
    }
  ...
  }), zr = (t, e, r, n, o, i) => __async(null, null, function* () {
    ...
    try {
      ...
      for (let W = 0; W < w; W++) yield Fc(r[W], T, E, t, p[e[W]], e[W], b);
      for (let W = 0; W < S; W++) yield Fc(o[W], I, E, t, m[n[W]], w + n[W], b);
      ...
      if (g && !y) {
        ...
        for (let Z = 0; Z < w; Z++) {
          let te = e[Z];
          (yield s._OrtBindInput(W, p[te], T[Z])) !== 0 && me(`Can't bind input[${Z}] for session=${t}.`);
        }
        for (let Z = 0; Z < S; Z++) {
          let te = n[Z];
      ...
      let q;
      g ? q = yield s._OrtRunWithBinding(c, g.handle, S, N, x) : q = yield s._OrtRun(c, M, v, w, K, S, N, x), q !== 0 && me("failed to call OrtRun().");
      let Q = [], D = [];
      ...
      for (let W = 0; W < S; W++) {
        ...
        try {
          ...
          if (ie === "string") {
            ...
            let Ue = yield Ce(t, we, U, Be, false);
            ...
            te = true, D.push((() => __async(null, null, function* () {
              let Fe = [$e, yield Ce];
      ...
      for (let [W, j] of yield Promise.all(D)) Q[W][2] = j;
...
var No = V(() => {
  ...
  Rt = () => !!ye.wasm.proxy && typeof document < "u", ur = false, hn = false, gn = false, Uo = /* @__PURE__ */ new Map(), Ft = (t, e) => {
    ...
    if (!hn) {
      ...
      try {
        yield Ar(ye.wasm), yield Er(ye), hn = true;
      } catch (t) {
        throw gn = true, t;
      } finally {
        ur = false;
  ...
  }), Kc = (t) => __async(null, null, function* () {
    ...
    yield kr(ye, t);
  }), jc = (t) => __async(null, null, function* () {
    return Rt() ? (qt(), new Promise((e, r) => {
      Ft("copy-from", [e, r]);
      let n = { type: "copy-from", in: { buffer: t } };
      He.postMessage(n, [t.buffer]);
    })) : Jt(t);
  }), Zc = (t, e) => __async(null, null, function* () {
    if (Rt()) {
      ...
      return qt(), new Promise((r, n) => {
        Ft("create", [r, n]);
        let o = { type: "create", in: { model: t, options: __spreadValues({}, e) } }, i = [];
        t instanceof Uint8Array && i.push(t.buffer), He.postMessage(o, i);
      });
    } else return Pr(t, e);
  }), Qc = (t) => __async(null, null, function* () {
    if (Rt()) return qt(), new Promise((e, r) => {
      Ft("release", [e, r]);
    ...
    Or(t);
  }), Yc = (t, e, r, n, o, i) => __async(null, null, function* () {
    if (Rt()) {
  ...
  }), Xc = (t) => __async(null, null, function* () {
    if (Rt()) return qt(), new Promise((e, r) => {
  ...
  Jc = (t, e) => {
    ...
    loadModel(e, r) {
      return __async(this, null, function* () {
        Ne();
        let n;
        typeof e == "string" ? n = yield this.fetchModelAndCopyToWasmMemory(e) : n = e, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = yield Zc(n, r), Me();
      });
    }
    dispose() {
      return __async(this, null, function* () {
    ...
    run(e, r, n) {
      return __async(this, null, function* () {
        ...
        let d = o.map((g, b) => Jc(g, () => `input "${this.inputNames[i[b]]}"`)), c = s.map((g, b) => g ? Jc(g, () => `output "${this.outputNames[u[b]]}"`) : null), p = yield Yc(this.sessionId, i, d, u, c, n), m = {};
...
var np = V(() => {
  ...
  tp = () => {
    ...
    init(e) {
      return __async(this, null, function* () {
        tp(), yield qc(), yield Kc(e);
      });
    }
    createInferenceSessionHandler(e, r) {
      return __async(this, null, function* () {
        let n = new yn();
        return yield n.loadModel(e, r), n;
      });
    }
  }, Qy = new bn();
});
